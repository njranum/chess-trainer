...
1. [ ] Models + migrations + admin  (starting point: `models.py` at repo root
       is the designed schema — split it across the apps listed under
       Conventions below, keep the comments)
2. [ ] `ingest` command
